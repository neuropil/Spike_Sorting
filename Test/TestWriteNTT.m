...
clc;clear;
%%
[TimeStamps, ScNumbers, CellNumbers, Params, DataPoints, header] =  getRawSE('Sample1');
%%
Params = Params(1:8,:);
CellNumbers(1:100)=1;
Mat2NlxTT('Sample1_x.ntt', ...
    0, 1, 1, length(TimeStamps), ...
    [1 1 1 1 1 0], ...
    TimeStamps, ScNumbers, CellNumbers, Params, DataPoints);
[TimeStamps, ScNumbers, CellNumbers, Params, DataPoints, header] =  getRawSE('Sample1_x');
